...
import hedaox.ninjinentities.entities.DBZ.EntityDodoria;
import hedaox.ninjinentities.entities.DBGT.EntityDragon;
import hedaox.ninjinentities.entities.DBS.EntityFrost1;
import hedaox.ninjinentities.entities.DBS.EntityFrost3;
import hedaox.ninjinentities.entities.DBS.EntityFrost4;
import hedaox.ninjinentities.entities.DBZ.EntityGoku2;
import hedaox.ninjinentities.entities.DBS.EntityGokuBlack;
...
import hedaox.ninjinentities.entities.DBS.EntityZamasu;
import hedaox.ninjinentities.entities.DBZ.EntityZarbon2;
...
public class NinjinRenderEntities {
	public static void init()
	{
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGohanUltimate.class, new RenderDBC(new ModelGohanUltimate(0.9778F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanBeast.class, new RenderDBC(new ModelGohanBeast(0.9778F), 0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityVegetoSsj3.class, new RenderDBC(new ModelGokuSsj3(1.0F), 0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityBbssj.class, new RenderDBC(new ModelBbssj2(1), 0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityBbssj2.class, new RenderDBC(new ModelBbssj3(1), 0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGokuSsj4.class, new RenderDBC(new ModelGokuSsj4(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGokuSsj5.class, new RenderDBC(new ModelGokuSsj4(1.0F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityBlockGokuSsjR3.class, new RenderDBC(new ModelGokuSsj3(1.0F), 1.0F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityBlockGohanUltimate.class, new RenderDBC(new ModelGohanUltimate(0.9778F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityDAIMAGoku.class, new RenderDBC(new ModelGoku(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityDAIMAGokuSsj.class, new RenderDBC(new ModelGokuSsj(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityDAIMAGokuSsj2.class, new RenderDBC(new ModelGokuSsj2(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityDAIMAGokuSsj3.class, new RenderDBC(new ModelGokuSsj3(1.0F), 0.5F));
