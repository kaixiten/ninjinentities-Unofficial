...
public class EntityDAIMAGokuSsj3 extends EntityDBCNinjin {
    public int randomSoundDelay = 0;
    public static int serverTickx = 0;

    public EntityDAIMAGokuSsj3(World par1World) {
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/DaimagokuSsj3.png";
	}
