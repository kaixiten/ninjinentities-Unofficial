...
import hedaox.ninjinentities.entities.IF.EntityGohanSsj4;
...
public class NinjinRenderEntities {
	public static void init()
	{
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityGokuSsj4.class, new RenderDBC(new ModelGeneralSsj4(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGokuSsj5.class, new RenderDBC(new ModelGeneralSsj4(1.0F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityGoku2XENO.class, new RenderDBC(new ModelGeneral1(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGoku2SsjXENO.class, new RenderDBC(new ModelGeneral1(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGoku2Ssj2XENO.class, new RenderDBC(new ModelGeneral1(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGoku2Ssj3XENO.class, new RenderDBC(new ModelGeneral1(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGokuXENO.class, new RenderDBC(new ModelGeneral1(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGokuSsjXENO.class, new RenderDBC(new ModelGeneral1(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGokuSsj2XENO.class, new RenderDBC(new ModelGeneral1(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGokuSsj3XENO.class, new RenderDBC(new ModelGeneral1(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGokuSsj4XENO.class, new RenderDBC(new ModelGeneralSsj4(1.0F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityFutureGohan.class, new RenderDBC(new ModelGeneral3(0.89F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityFutureGohan2.class, new RenderDBC(new ModelGeneral3(0.89F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityFutureGohanSsj.class, new RenderDBC(new ModelGeneral2(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityFutureGohan2Ssj.class, new RenderDBC(new ModelGeneral2(0.9F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanHighSchool.class, new RenderDBC(new ModelGeneral3(0.9778F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanSsjHighSchool.class, new RenderDBC(new ModelGeneral3(0.9778F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanSaiyamanSsj.class, new RenderDBC(new ModelGeneral3(0.9778F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanSaiyamanSsj2.class, new RenderDBC(new ModelGeneral2(0.9778F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityGTTrunks.class, new RenderDBC(new ModelTrunks(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTTrunksSsj.class, new RenderDBC(new ModelTrunksSsj(1.0F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityVegetoSsjKisword.class, new RenderDBC(new ModelVegetoKisword(0.91F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityVegetoSsjbKisword.class, new RenderDBC(new ModelVegetoKisword(0.91F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntitysuperMajinBuuVegeto.class, new RenderDBC(new ModelBuuSuper_Ultimate(), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityGTGogetaSsj4.class, new RenderDBC(new ModelGeneralSsj4(1.0F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityVegetaSsj4.class, new RenderDBC(new ModelGeneralSsj4(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTvegeta.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTvegeta2.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTvegetaSsj.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTvegeta2Ssj.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTvegetaSsj2.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTvegeta2Ssj2.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityvegetaXENO.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityvegetaSsjXENO.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityvegetaSsj2XENO.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityVegetaSsj3XENO.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityVegetaSsj4XENO.class, new RenderDBC(new ModelGeneralSsj4(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entityvegeta2XENO.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entityvegeta2SsjXENO.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entityvegeta2Ssj2XENO.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityVegeta2Ssj3XENO.class, new RenderDBC(new ModelGeneral1(0.9F), 0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGokuBlackR.class, new RenderDBC(new ModelGokuBlackRose(1.0F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityMrpopo.class, new RenderDBC(new ModelNPCNormalScale(1.15F, 0.9F, 1.15F), 0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCoolerFifthForm.class, new RenderDBC(new ModelCoolerFifthForm(1.1F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityBdkSsj4.class, new RenderDBC(new ModelGeneralSsj4(0.93F), 0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityBbssj.class, new RenderDBC(new ModelBbssj(1), 0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityZsCoolerFifthForm.class, new RenderDBC(new ModelCoolerFifthForm(1.1F), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(EntityGoldCoolerFifthForm.class, new RenderDBC(new ModelCoolerFifthForm(1.1F), 0.5F));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityMara_Young.class, new RenderDBC(new ModelYoung_mara(2), 1.0F));
		RenderingRegistry.registerEntityRenderingHandler(EntityMara_Fusion.class, new RenderDBC(new ModelFusion_Mara(2), 1.0F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityBlockGohanUltimate.class, new RenderDBC(new ModelGeneral2(0.91F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanXENO.class, new RenderDBC(new ModelGeneral3(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohan2XENO.class, new RenderDBC(new ModelGeneral3(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanSsjXENO.class, new RenderDBC(new ModelGeneral2(0.91F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanSsj2XENO.class, new RenderDBC(new ModelGeneral3(0.91F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanSsj3XENO.class, new RenderDBC(new ModelGeneral3(0.91F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanSsj4XENO.class, new RenderDBC(new ModelGeneralSsj4(0.91F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanSsj4.class, new RenderDBC(new ModelGeneralSsj4(0.91F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGohanUltimateXENO.class, new RenderDBC(new ModelGeneral2(0.91F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTgohan.class, new RenderDBC(new ModelGeneral2(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTgohan2.class, new RenderDBC(new ModelGeneral2(0.9F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGTgohanSsj.class, new RenderDBC(new ModelGeneral2(0.91F), 0.5F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(Entity2Stars.class, new RenderDBC(new Model2stars(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entity3Stars.class, new RenderDBC(new Model3or4stars(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entity4Stars.class, new RenderDBC(new Model3or4stars(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entity4StarsFullPower.class, new RenderDBC(new Model3or4stars(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entity5Stars.class, new RenderDBC(new Model5Stars(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entity5StarsFullPower.class, new RenderDBC(new Model5Stars(2.0F), 1.0F));
        RenderingRegistry.registerEntityRenderingHandler(Entity6Stars.class, new RenderDBC(new Model6Stars(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entity6StarsTrueform.class, new RenderDBC(new Model6StarsTrueform(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entity7Stars.class, new RenderDBC(new Model7Stars(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entity7StarsPan.class, new RenderDBC(new Model7StarsPan(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entity7StarsTrue.class, new RenderDBC(new Model7StarsTrue(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entitylude.class, new RenderDBC(new Modellude(2.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityludeFullPower.class, new RenderDBC(new Modellude(2.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityPikkon.class, new RenderDBC(new Modelpikkon(0.91F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityLedgic.class, new RenderDBC(new ModelLedgic(2.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entitylierde.class, new RenderDBC(new Modellierde(1.0F), 0.5F));
        RenderingRegistry.registerEntityRenderingHandler(Entityhetilierde.class, new RenderDBC(new Modelhetilierde(1.0F), 0.5F));
