...
public class Model7StarsTrue extends ModelBase {
	...
	public Model7StarsTrue(float _scale) {
		textureWidth = 128;
		textureHeight = 128;
        scale = _scale;
		...
		bipedHead.cubeList.add(new ModelBox(bipedHead, 42, 48, -2.0F, -6.75F, -2.0F, 4, 4, 4, 0.0F));
		...
		Line_r1.cubeList.add(new ModelBox(Line_r1, 56, 18, 0.0F, -5.0F, -1.0F, 0, 5, 5, 0.0F));
		...
		Line_r2.cubeList.add(new ModelBox(Line_r2, 56, 8, 0.0F, -5.0F, -1.0F, 0, 5, 5, 0.0F));
		...
		Tail2.cubeList.add(new ModelBox(Tail2, 0, 31, -2.0F, -4.0F, -3.0F, 6, 5, 6, 0.0F));

		Tail3 = new ModelRenderer(this);
		Tail3.setRotationPoint(1.0F, -1.75F, 3.0F);
		Tail2.addChild(Tail3);
		setRotationAngle(Tail3, 0.3927F, 0.0F, 0.0F);
		Tail3.cubeList.add(new ModelBox(Tail3, 24, 39, -2.0F, -3.0F, -1.0F, 4, 5, 5, 0.0F));

		Tail4 = new ModelRenderer(this);
		Tail4.setRotationPoint(-1.0F, -0.75F, 6.0F);
		Tail3.addChild(Tail4);
		setRotationAngle(Tail4, 0.3927F, 0.0F, 0.0F);
		Tail4.cubeList.add(new ModelBox(Tail4, 48, 31, -0.5F, -3.0F, -3.0F, 3, 3, 5, 0.0F));

		bipedRightArm = new ModelRenderer(this);
		bipedRightArm.setRotationPoint(-5.0F, 10.0F, -1.0F);
		bipedBody.addChild(bipedRightArm);
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 18, 49, -1.0F, -2.0F, -1.5F, 2, 10, 3, 0.0F));

		bipedLeftArm = new ModelRenderer(this);
		bipedLeftArm.setRotationPoint(5.0F, 10.0F, -1.0F);
		bipedBody.addChild(bipedLeftArm);
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 28, 49, -1.0F, -2.0F, -1.5F, 2, 10, 3, 0.0F));

		bipedRightLeg = new ModelRenderer(this);
		bipedRightLeg.setRotationPoint(-1.9F, 21.0F, 0.0F);
		bipedBody.addChild(bipedRightLeg);
		bipedRightLeg.cubeList.add(new ModelBox(bipedRightLeg, 24, 31, -4.0F, 2.0F, -6.0F, 5, 1, 7, 0.0F));
		bipedRightLeg.cubeList.add(new ModelBox(bipedRightLeg, 0, 42, -3.5F, -2.0F, -4.0F, 4, 4, 5, 0.25F));

		bipedLeftLeg = new ModelRenderer(this);
		bipedLeftLeg.setRotationPoint(1.9F, 21.0F, 0.0F);
		bipedBody.addChild(bipedLeftLeg);
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 34, 0, -1.0F, 2.0F, -6.0F, 5, 1, 7, 0.0F));
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 42, 39, -0.5F, -2.0F, -4.0F, 4, 4, 5, 0.25F));
	}
