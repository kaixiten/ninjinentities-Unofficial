...
public class ModelHirudegarnBottom extends ModelBase {
	...
	public ModelHirudegarnBottom(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bipedBody.addChild(Portal);
		Portal.cubeList.add(new ModelBox(Portal, 44, 221, -26.0F, -44.0F, -15.0F, 50, 1, 30, 0.0F));

		bipedRightLeg = new ModelRenderer(this);
		bipedRightLeg.setRotationPoint(-7.0F, -18.0F, -1.0F);
		setRotationAngle(bipedRightLeg, -0.1309F, 0.0F, 0.0F);
		bipedBody.addChild(bipedRightLeg);
		bipedRightLeg.cubeList.add(new ModelBox(bipedRightLeg, 97, 121, -3.0F, -1.388F, -2.3382F, 6, 15, 6, 0.0F));

		bipedRightLeg2 = new ModelRenderer(this);
		bipedRightLeg2.setRotationPoint(-6.0F, 27.4131F, 6.6975F);
		...
		bipedLeftLeg.setRotationPoint(7.0F, -18.0F, 0.0F);
		setRotationAngle(bipedLeftLeg, -0.1309F, 0.0F, 0.0F);
		bipedBody.addChild(bipedLeftLeg);
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 97, 121, -3.0F, -1.2575F, -3.3296F, 6, 15, 6, 0.0F));
