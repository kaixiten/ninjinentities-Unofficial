...
public class ModelVegetaArmorDamaged extends ModelBase {
	...
	public ModelVegetaArmorDamaged(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 0, 0, 12.02F, -2.0F, -1.0F, 0, 2, 2, 0.0F));
		...
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 0, 0, 3.0F, 2.0F, -2.02F, 2, 2, 0, 0.0F));
	}
