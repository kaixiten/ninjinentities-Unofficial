...
public class ModelDaiz extends ModelBase {
	...
	public ModelDaiz(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 16, 34, -4.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F));
		...
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 44, 46, 8.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F));
		...
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 32, 34, 2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F));
