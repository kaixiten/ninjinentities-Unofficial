...
public class ModelNPCNormalCape extends ModelBase {
	...
	public ModelNPCNormalCape(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bipedHead.cubeList.add(new ModelBox(bipedHead, 23, 0, -4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F));
		...
		bipedBody.cubeList.add(new ModelBox(bipedBody, 39, 16, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.0F));
		...
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 63, 16, -4.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F));

		bipedLeftArm = new ModelRenderer(this);
		bipedLeftArm.setRotationPoint(4.0F, 2.0F, 0.0F);
		bipedBody.addChild(bipedLeftArm);
		bipedLeftArm.mirror = true;
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 63, 16, 0.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F));

		bipedRightLeg = new ModelRenderer(this);
		bipedRightLeg.setRotationPoint(-1.9F, 12.0F, 0.1F);
		bipedBody.addChild(bipedRightLeg);
		bipedRightLeg.cubeList.add(new ModelBox(bipedRightLeg, 23, 16, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F));

		bipedLeftLeg = new ModelRenderer(this);
		bipedLeftLeg.setRotationPoint(1.9F, 12.0F, 0.1F);
		bipedBody.addChild(bipedLeftLeg);
		bipedLeftLeg.mirror = true;
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 23, 16, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F));
	}
