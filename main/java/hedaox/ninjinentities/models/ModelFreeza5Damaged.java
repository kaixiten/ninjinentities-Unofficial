...
public class ModelFreeza5Damaged extends ModelBase {
	...
	public ModelFreeza5Damaged(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bipedBody.cubeList.add(new ModelBox(bipedBody, 64, 0, -4.0F, 0.0F, -2.0F, 8, 5, 4, 0.0F));
		...
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 64, 48, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F));
