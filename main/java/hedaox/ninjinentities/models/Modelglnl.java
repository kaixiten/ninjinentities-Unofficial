...
public class Modelglnl extends ModelBase {
	...
	public Modelglnl(float _scale) {
		...
		Head.cubeList.add(new ModelBox(Head, 0, 0, -4.0F, -32.0F, -4.0F, 8, 8, 8, 0.0F));

		bone5 = new ModelRenderer(this);
		bone5.setRotationPoint(0.5284F, -34.1338F, -3.9196F);
		Head.addChild(bone5);
		...
		bone3.setRotationPoint(1.7141F, -33.4245F, -4.1921F);
		Head.addChild(bone3);
		...
		bone1.setRotationPoint(-0.3171F, -33.3105F, -2.52F);
		Head.addChild(bone1);
		...
		Hair19.setRotationPoint(-1.2151F, -34.3399F, 1.2173F);
		Head.addChild(Hair19);
		setRotationAngle(Hair19, -0.2753F, 0.5737F, 0.1595F);
		Hair19.cubeList.add(new ModelBox(Hair19, 38, 4, 0.0855F, -1.0434F, -2.6165F, 2, 3, 2, 0.0F));

		Hair18 = new ModelRenderer(this);
		Hair18.setRotationPoint(1.0F, -34.0F, 1.0F);
		Head.addChild(Hair18);
		setRotationAngle(Hair18, -2.0071F, 0.0F, 0.0F);
		Hair18.cubeList.add(new ModelBox(Hair18, 46, 4, -1.5F, 0.8126F, -0.4548F, 3, 2, 3, 0.0F));

		Hair17 = new ModelRenderer(this);
		Hair17.setRotationPoint(1.0F, -34.0F, 1.0F);
		...
		Hair17_r1.cubeList.add(new ModelBox(Hair17_r1, 38, 4, -1.0F, -0.8617F, -2.1472F, 2, 5, 2, 0.0F));

		Hair16 = new ModelRenderer(this);
		Hair16.setRotationPoint(-3.0F, -32.0F, 4.5F);
		Head.addChild(Hair16);
		setRotationAngle(Hair16, -0.2182F, -0.1833F, 0.0F);
		Hair16.cubeList.add(new ModelBox(Hair16, 47, 5, -0.2646F, -3.5269F, -3.7528F, 3, 4, 3, 0.0F));

		Hair15 = new ModelRenderer(this);
		Hair15.setRotationPoint(-3.0F, -32.0F, 4.5F);
		Head.addChild(Hair15);
		setRotationAngle(Hair15, -0.2182F, -0.1833F, 0.0F);
		Hair15.cubeList.add(new ModelBox(Hair15, 47, 5, -1.3646F, -1.5743F, -3.3199F, 4, 6, 3, 0.0F));

		Hair14 = new ModelRenderer(this);
		Hair14.setRotationPoint(3.5F, -32.5F, 5.5F);
		Head.addChild(Hair14);
		setRotationAngle(Hair14, -0.2182F, 0.1187F, 0.0F);
		Hair14.cubeList.add(new ModelBox(Hair14, 47, 5, -3.0632F, 0.4299F, -3.9888F, 4, 5, 3, 0.0F));

		Hair13 = new ModelRenderer(this);
		Hair13.setRotationPoint(0.0F, -30.5F, 6.0F);
		Head.addChild(Hair13);
		setRotationAngle(Hair13, -0.3927F, 0.0F, 0.0F);
		Hair13.cubeList.add(new ModelBox(Hair13, 39, 7, -2.0F, -0.7346F, -3.1578F, 4, 4, 2, 0.0F));

		Hair9 = new ModelRenderer(this);
		Hair9.setRotationPoint(2.2F, -32.0F, 3.6F);
		Head.addChild(Hair9);
		setRotationAngle(Hair9, -0.672F, 0.0F, 0.2182F);
		Hair9.cubeList.add(new ModelBox(Hair9, 48, 2, -1.7F, -1.1549F, -3.6652F, 3, 6, 3, 0.0F));

		Hair7 = new ModelRenderer(this);
		Hair7.setRotationPoint(1.0F, -33.5F, 4.5F);
		Head.addChild(Hair7);
		setRotationAngle(Hair7, -0.0436F, 0.0F, 0.0F);
		Hair7.cubeList.add(new ModelBox(Hair7, 40, 3, -2.2F, -1.6128F, -3.5981F, 4, 4, 3, 0.0F));

		Hair6 = new ModelRenderer(this);
		Hair6.setRotationPoint(5.0F, -32.0F, -1.0F);
		Head.addChild(Hair6);
		setRotationAngle(Hair6, -0.4799F, 0.0F, 0.1745F);
		Hair6.cubeList.add(new ModelBox(Hair6, 46, 2, -4.4F, -2.0766F, -0.2741F, 4, 3, 3, 0.0F));

		Hair5 = new ModelRenderer(this);
		Hair5.setRotationPoint(1.0F, -34.0F, 1.0F);
		Head.addChild(Hair5);
		setRotationAngle(Hair5, -0.6545F, 0.0F, 0.0F);
		Hair5.cubeList.add(new ModelBox(Hair5, 38, 4, -1.0F, -3.1485F, -1.2207F, 2, 3, 2, 0.0F));

		Hair4 = new ModelRenderer(this);
		Hair4.setRotationPoint(1.0F, -34.0F, 1.0F);
		Head.addChild(Hair4);
		setRotationAngle(Hair4, -0.5236F, 0.0F, 0.0F);
		Hair4.cubeList.add(new ModelBox(Hair4, 46, 4, -1.5F, -1.0F, -2.032F, 3, 3, 3, 0.0F));

		Hair8 = new ModelRenderer(this);
		Hair8.setRotationPoint(5.0F, -31.0F, 0.0F);
		Head.addChild(Hair8);
		setRotationAngle(Hair8, -0.48F, 0.0F, 0.3927F);
		Hair8.cubeList.add(new ModelBox(Hair8, 45, 3, -4.3F, -0.2764F, -2.2006F, 4, 4, 3, 0.0F));

		bone4 = new ModelRenderer(this);
		bone4.setRotationPoint(-6.0F, -1.6F, 2.5F);
		Hair8.addChild(bone4);
		setRotationAngle(bone4, -0.3491F, 0.0873F, -0.7854F);
		bone4.cubeList.add(new ModelBox(bone4, 41, 5, -3.7459F, -0.9408F, -2.8677F, 4, 5, 3, 0.0F));

		bone19 = new ModelRenderer(this);
		bone19.setRotationPoint(-6.3827F, -3.343F, 3.8474F);
		Hair8.addChild(bone19);
		setRotationAngle(bone19, -0.3491F, 0.3491F, -0.6545F);
		bone19.cubeList.add(new ModelBox(bone19, 41, 5, -2.6388F, -0.8539F, -2.8734F, 3, 5, 3, 0.0F));

		Hair2 = new ModelRenderer(this);
		Hair2.setRotationPoint(0.5F, -32.5F, 0.0F);
		Head.addChild(Hair2);
		setRotationAngle(Hair2, -0.4363F, 0.0F, 0.0436F);
		Hair2.cubeList.add(new ModelBox(Hair2, 40, 4, -1.5F, -0.6132F, -3.1126F, 4, 3, 2, 0.0F));

		Hair1 = new ModelRenderer(this);
		Hair1.setRotationPoint(-2.1F, -32.7F, 1.5F);
		Head.addChild(Hair1);
		setRotationAngle(Hair1, -0.3054F, 0.0F, -0.3491F);
		Hair1.cubeList.add(new ModelBox(Hair1, 40, 4, -2.4F, -0.6987F, -3.9075F, 4, 3, 4, 0.0F));

		Hair20 = new ModelRenderer(this);
		Hair20.setRotationPoint(1.3892F, -34.2882F, 4.4164F);
		Head.addChild(Hair20);
		setRotationAngle(Hair20, -1.2217F, 0.0F, -0.0873F);
		Hair20.cubeList.add(new ModelBox(Hair20, 38, 4, -1.0F, -0.6206F, -1.684F, 2, 5, 2, 0.0F));

		SSJ3 = new ModelRenderer(this);
		SSJ3.setRotationPoint(0.0F, -32.0F, 1.0F);
		Head.addChild(SSJ3);
		setRotationAngle(SSJ3, 0.0436F, 0.0F, 0.0F);


		hair21 = new ModelRenderer(this);
		hair21.setRotationPoint(-1.0F, -9.0F, 0.0F);
		SSJ3.addChild(hair21);
		setRotationAngle(hair21, -1.309F, 0.0F, 0.6109F);
		hair21.cubeList.add(new ModelBox(hair21, 42, 2, 4.0712F, -4.4428F, 4.1621F, 4, 8, 4, 0.0F));

		hair22 = new ModelRenderer(this);
		hair22.setRotationPoint(-3.0F, -10.0F, 0.0F);
		SSJ3.addChild(hair22);
		setRotationAngle(hair22, -0.3491F, 0.0F, 0.2618F);
		hair22.cubeList.add(new ModelBox(hair22, 45, 2, 2.1289F, 4.7157F, -0.687F, 3, 6, 3, 0.0F));

		hair23 = new ModelRenderer(this);
		hair23.setRotationPoint(1.0F, -8.0F, 0.0F);
		SSJ3.addChild(hair23);
		setRotationAngle(hair23, -0.3491F, 0.0F, -0.0873F);
		hair23.cubeList.add(new ModelBox(hair23, 45, 2, -0.6366F, 4.259F, -0.6043F, 3, 6, 3, 0.0F));
		...
		hair24.cubeList.add(new ModelBox(hair24, 45, 2, 3.1514F, 4.3781F, -3.167F, 2, 6, 3, 0.0F));
		...
		hair25.cubeList.add(new ModelBox(hair25, 45, 2, -4.5394F, -10.3785F, -4.7561F, 3, 6, 3, 0.0F));
		...
		hair26.cubeList.add(new ModelBox(hair26, 45, 2, -1.5676F, 0.679F, 4.469F, 3, 6, 3, 0.0F));
		...
		hair27.cubeList.add(new ModelBox(hair27, 45, 2, 5.8061F, 3.2744F, -0.0199F, 3, 5, 5, 0.0F));
		...
		hair28.cubeList.add(new ModelBox(hair28, 45, 2, -3.337F, -10.9973F, -5.0933F, 3, 6, 3, 0.0F));
		...
		hair29.cubeList.add(new ModelBox(hair29, 45, 2, 4.0086F, -10.4748F, -5.5873F, 3, 6, 3, 0.0F));
		...
		hair30.cubeList.add(new ModelBox(hair30, 43, 2, 1.1165F, -8.7341F, 3.5159F, 3, 5, 3, 0.0F));
		...
		hair31.cubeList.add(new ModelBox(hair31, 42, 2, 0.907F, -7.7303F, 2.5242F, 3, 5, 3, 0.0F));
		...
		hair32.cubeList.add(new ModelBox(hair32, 42, 2, 1.9972F, -6.7253F, -0.465F, 4, 4, 3, 0.0F));
		...
		hair34.cubeList.add(new ModelBox(hair34, 42, 2, 3.0206F, -10.3289F, 1.7406F, 4, 5, 3, 0.0F));
		...
		hair35.cubeList.add(new ModelBox(hair35, 42, 2, -4.1222F, -9.4638F, 1.7065F, 3, 5, 3, 0.0F));
		...
		hair36.cubeList.add(new ModelBox(hair36, 42, 2, -2.6103F, -9.1585F, 4.1202F, 3, 4, 3, 0.0F));
		...
		hair37.cubeList.add(new ModelBox(hair37, 42, 2, -0.3897F, -9.1585F, 4.1202F, 3, 4, 3, 0.0F));
	}
