...
public class Modelomega extends ModelBase {
	...
	public Modelomega(float _scale) {
		...
		bipedHead.cubeList.add(new ModelBox(bipedHead, 0, 0, -4.0F, -8.0F, -2.0F, 8, 8, 8, 0.0F));
		...
		bipedBody.setRotationPoint(-4.0F, 0.0F, -2.0F);
		bipedBody.cubeList.add(new ModelBox(bipedBody, 16, 16, 0.0F, 0.0F, 0.0F, 8, 12, 4, 0.1F));

        ModelRenderer backFang1 = new ModelRenderer(this);
		backFang1.setRotationPoint(1.0F, 2.6F, 3.3F);
		bipedBody.addChild(backFang1);
        ...
        ModelRenderer dragonBall4 = new ModelRenderer(this);
		dragonBall4.setRotationPoint(3.0F, 2.2F, -1.0F);
		bipedBody.addChild(dragonBall4);
		...
		bipedRightLeg.addChild(rightLegFang);
		...
		bipedLeftLeg.addChild(leftLegFang);
	...
	public void setRotateAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
	{
		...
		if (this.onGround > -9990.0F)
		{
			...
			this.rightarm.rotationPointX = (-MathHelper.cos(this.bipedBody.rotateAngleY) * 6.0F);
			...
			this.rightarm.rotateAngleY += this.bipedBody.rotateAngleY * 2.0F;
