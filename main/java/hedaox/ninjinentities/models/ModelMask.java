...
public class ModelMask extends ModelBase {
    ...
    public ModelMask(float _scale) {
        ...
        strand1.cubeList.add(new ModelBox(strand1, 38, 2, 1.2F, -1.6F, -3.1018F, 2, 5, 2, 0.0F));
        ...
        strand3.cubeList.add(new ModelBox(strand3, 38, 2, 1.5441F, -1.5F, -3.7609F, 2, 3, 2, 0.0F));
        ...
        strand4.cubeList.add(new ModelBox(strand4, 38, 2, 1.5F, -1.06F, -3.7609F, 2, 3, 2, 0.0F));
