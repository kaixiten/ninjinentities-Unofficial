...
public class ModelAngol extends ModelBase {
	...
	public ModelAngol(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bone.addChild(bipedHeadChild_2);
		bipedHeadChild_2.cubeList.add(new ModelBox(bipedHeadChild_2, 52, 9, 4.5F, -6.0F, -1.866F, 0, 4, 6, 0.0F));
		...
		bone.addChild(bipedHeadChild_1);
		bipedHeadChild_1.cubeList.add(new ModelBox(bipedHeadChild_1, 52, 9, -4.5F, -6.0F, -1.866F, 0, 4, 6, 0.0F));
