...
public class ModelRasinLakasei extends ModelBase {
	...
	public ModelRasinLakasei(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bipedHead.cubeList.add(new ModelBox(bipedHead, 25, 26, -4.0F, 0.0F, -4.0F, 8, 8, 8, 0.0F));
		bipedHead.cubeList.add(new ModelBox(bipedHead, 0, 72, -4.0F, 5.0F, -4.0F, 8, 3, 9, 0.5F));

		bipedBody = new ModelRenderer(this);
		bipedBody.setRotationPoint(0.2F, 5.4F, -0.2F);
		bipedBody.cubeList.add(new ModelBox(bipedBody, 34, 12, -4.2F, 2.6F, -1.8F, 8, 8, 4, 0.0F));
		...
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 48, 48, -4.0F, 6.0F, -2.0F, 4, 8, 4, 0.0F));

		bipedLeftArm = new ModelRenderer(this);
		bipedLeftArm.setRotationPoint(-4.2F, -3.4F, 0.2F);
		bipedBody.addChild(bipedLeftArm);
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 54, 20, 8.0F, 6.0F, -2.0F, 4, 8, 4, 0.0F));

		bipedRightLeg = new ModelRenderer(this);
		bipedRightLeg.setRotationPoint(-2.2F, 6.6F, 0.2F);
		bipedBody.addChild(bipedRightLeg);
		bipedRightLeg.cubeList.add(new ModelBox(bipedRightLeg, 0, 43, -2.0F, 4.0F, -2.0F, 4, 8, 4, 0.0F));

		bipedLeftLeg = new ModelRenderer(this);
		bipedLeftLeg.setRotationPoint(-2.2F, 6.6F, 0.2F);
		bipedBody.addChild(bipedLeftLeg);
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 16, 43, 2.0F, 4.0F, -2.0F, 4, 8, 4, 0.0F));
	}
