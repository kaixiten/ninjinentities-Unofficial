...
public class ModelAboKado extends ModelBase {
	...
	public ModelAboKado(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bipedBody.setRotationPoint(0.2F, 6.4F, -0.2F);
		bipedBody.cubeList.add(new ModelBox(bipedBody, 16, 16, -4.2F, -5.4F, -1.8F, 8, 12, 4, 1.0F));

		bipedRightArm = new ModelRenderer(this);
		bipedRightArm.setRotationPoint(-4.2F, -3.4F, 0.2F);
		bipedBody.addChild(bipedRightArm);
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 40, 16, -4.0F, -3.0F, -2.0F, 4, 12, 4, 0.0F));
		...
		bipedLeftArm.setRotationPoint(-4.2F, -4.4F, 0.2F);
		...
		bipedRightLeg.setRotationPoint(-2.2F, 5.6F, 0.2F);
		bipedBody.addChild(bipedRightLeg);
		bipedRightLeg.cubeList.add(new ModelBox(bipedRightLeg, 0, 16, -2.0F, 2.0F, -2.0F, 4, 10, 4, 0.0F));

		bipedLeftLeg = new ModelRenderer(this);
		bipedLeftLeg.setRotationPoint(-2.2F, 5.6F, 0.2F);
		bipedBody.addChild(bipedLeftLeg);
		bipedLeftLeg.mirror = true;
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 0, 16, 2.0F, 2.0F, -2.0F, 4, 10, 4, 0.0F));
	}
