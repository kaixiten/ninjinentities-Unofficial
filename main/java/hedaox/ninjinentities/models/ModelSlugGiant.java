...
public class ModelSlugGiant extends ModelBase {
	...
	public ModelSlugGiant(float _scaleX, float _scaleY, float _scaleZ) {
		...
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 32, 44, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F));

		bipedLeftArm = new ModelRenderer(this);
		bipedLeftArm.setRotationPoint(5.0F, 2.0F, 0.0F);
		bipedBody.addChild(bipedLeftArm);
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 32, 0, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F));
		...
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 16, 40, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F));
	}
