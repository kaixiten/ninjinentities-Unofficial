...
public class ModelBiomen extends ModelBase {
    ...
    public ModelBiomen(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        ModelRenderer bipedHeadChild_2 = new ModelRenderer(this);
        ...
        ModelRenderer bipedHeadChild_1 = new ModelRenderer(this);
		...
		bipedRightArm.setRotationPoint(-4.2F, 3.6F, 0.2F);
		bipedBody.addChild(bipedRightArm);
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 28, 12, -4.0F, -1.0F, -2.0F, 4, 8, 4, 0.0F));

		bipedLeftArm = new ModelRenderer(this);
		bipedLeftArm.setRotationPoint(3.8F, 3.6F, 0.2F);
		bipedBody.addChild(bipedLeftArm);
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 32, 32, 0.0F, -1.0F, -2.0F, 4, 8, 4, 0.0F));

		bipedRightLeg = new ModelRenderer(this);
		bipedRightLeg.setRotationPoint(-2.2F, 10.6F, 0.2F);
		bipedBody.addChild(bipedRightLeg);
		bipedRightLeg.cubeList.add(new ModelBox(bipedRightLeg, 20, 24, -2.0F, 0.0F, -2.0F, 4, 8, 4, 0.0F));

		bipedLeftLeg = new ModelRenderer(this);
		bipedLeftLeg.setRotationPoint(1.8F, 10.6F, 0.2F);
		bipedBody.addChild(bipedLeftLeg);
		bipedLeftLeg.cubeList.add(new ModelBox(bipedLeftLeg, 0, 28, -2.0F, 0.0F, -2.0F, 4, 8, 4, 0.0F));
	}
