...
public class EntityGokuUIM extends EntityDBCNinjin {
    ...
    public EntityGokuUIM(World par1World) {
        ...
        // 初始化闪避参数
        this.dodgeSystem.dodge = (int)ModConfig.gokuUIMDodgeRate;
        this.dodgeSystem.strikeBack = (int)ModConfig.gokuUIMCounterChance;
    }

    @Override
    protected void applyEntityAttributes() {
        super.applyEntityAttributes();
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(170000.0D);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(17000.0D);
    }
