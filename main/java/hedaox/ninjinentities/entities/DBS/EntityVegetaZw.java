...
public class EntityVegetaZw extends EntityDBCNinjin {
    ...
    protected void applyEntityAttributes() {
        ...
        getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(68500.0D);
        getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(6850.0D);
    }
