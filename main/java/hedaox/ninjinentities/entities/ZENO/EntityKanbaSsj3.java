...
public class EntityKanbaSsj3 extends EntityDBCNinjin {


	public EntityKanbaSsj3(World par1World) {
		super(par1World, 100, MindState.AGGRESSIVE, false, false, new byte[]{3, 3, 1, 6, 5, 2}, new byte[]{2, 2, 2, 2, 2, 7}, 255.0F, 217.0F, 25.0F, true);
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/kanbassj3.png";
	}
}
