...
public class EntityDAIMAGokuSsj2 extends EntityDBCNinjin {
	public int randomSoundDelay = 0;

	public EntityDAIMAGokuSsj2(World par1World) {
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/DaimagokuSsj2.png";
	}
