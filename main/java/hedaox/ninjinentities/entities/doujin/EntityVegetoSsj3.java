...
public class EntityVegetoSsj3 extends EntityDBCNinjin {

	public int randomSoundDelay = 0;

	public EntityVegetoSsj3(World par1World) {
		super(par1World, 85, MindState.AGGRESSIVE, true, true, new byte[]{1, 2, 3, 4, 5, 6}, new byte[]{7, 7, 2, 2, 7, 2}, 255.0F, 217.0F, 25.0F, true);
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/vegetoSsj3.png";
	}
}
