...
public class EntityGTvegeta2Ssj2 extends EntityDBCNinjin {

	public int randomSoundDelay = 0;

	public EntityGTvegeta2Ssj2(World par1World) {
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/vegetaGT2Ssj.png";
	}
}
