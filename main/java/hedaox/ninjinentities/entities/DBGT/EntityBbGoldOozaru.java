...
public class EntityBbGoldOozaru extends EntityDBCNinjin {

	public int randomSoundDelay = 0;

	public EntityBbGoldOozaru(World par1World) {
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/bbGoldoozaru.png";
	}
}
