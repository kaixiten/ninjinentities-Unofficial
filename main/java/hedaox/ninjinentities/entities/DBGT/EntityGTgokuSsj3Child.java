...
public class EntityGTgokuSsj3Child extends EntityDBCNinjin {

	public int randomSoundDelay = 0;

	public EntityGTgokuSsj3Child(World par1World) {
	...
	public String getTexture() {
		return ModVars.MOD_ID + ":textures/entity/GTgokuSsj3.png";
	}
}
